    ...
    getCommonDatas: (form: FormData) => {
        ...
        const baseDatas = {
            ...
            team: {
                ...
                wrestler: form.get('team-wrestler-champion') ? Number(form.get('team-wrestler-champion')) : null,
                partner: form.get('team-wrestler-partner') ? Number(form.get('team-wrestler-partner')) : null,
            },
            no_team: {
                members: {
