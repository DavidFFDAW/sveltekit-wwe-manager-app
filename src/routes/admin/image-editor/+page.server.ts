...
export const actions = {
    upsertImage: async ({ request, locals }) => {
        ...
        try {
            ...
            if (!uploadResponse.ok) return Helpers.error('No se ha podido subir la imagen al servidor', 500);
            ...
            if (!newImageURL) return Helpers.error('No se ha podido obtener la URL de la imagen subida', 500);
